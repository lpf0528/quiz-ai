...
class Retriever(abc.ABC):
    ...
    def list_resources(self, query: str | None = None) -> list[Resource]:
        """
        List all resources available in the RAG provider.
        """
        pass

    @abc.abstractmethod
    def query_relevant_documents(self, query: str, resources: list[Resource] = []) -> list[Resource]:
        """
        Query the RAG provider with the given query.
        """
        pass
...
if __name__ == '__main__':
    print(parse_uri("rag:document/123#456"))
